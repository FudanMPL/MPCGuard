...
if __name__ == '__main__':
    ...
    folder_path = "./real-data/ass_ltz/s-"+str(args.secret)+"/"
    if args.no_record:
    ...
    for i in tqdm(range(args.try_times)):
        ...
        command0 = ["./semi2k-party.x", "0", "ltz", "-OF", ".", "-pn", "14752", "-h", "localhost",  "-b", "1", "-B", "3"]
        command1 = ["./semi2k-party.x", "1", "ltz", "-OF", ".", "-pn", "14752", "-h", "localhost",  "-b", "1", "-B", "3"]
        command2 = ["./semi2k-party.x", "2", "ltz", "-OF", ".", "-pn", "14752", "-h", "localhost",  "-b", "1", "-B", "3"]
