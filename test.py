...
tools_and_global_parameters.ideal_protocol_functionality = functionality.F_ass_mul
tools_and_global_parameters.number_of_party = 2
...
tools_and_global_parameters.real_data_dir = "./real-data/ass_ltz/"
...
logger.info(f"  time: {tools_and_global_parameters.timer['model_train_and_test']}")
